...
def save_to_csv(title, ingredients):
    with open("recipes_viandes.csv", mode="a", newline="", encoding="utf-8") as file:
...
# Create a new CSV with headers for "viandes"
with open("recipes_viandes.csv", mode="w", newline="", encoding="utf-8") as file:
    writer = csv.writer(file)
    writer.writerow(["Titre", "Ingrédients", "Instructions"])

# Scrape the first three pages of the "viandes" category
base_url = "https://www.cuisineaz.com/categories/plats/viandes-cat48916"
