...
class Application(tk.Tk):
    ...
    def __init__(self):
        ...
        # Ajout d'un titre
        tk.Label(self, text="Application de Cuisine", bg="#1a1a2e", fg="white", font=("fantasy", 20, "bold")).pack(pady=20)
    ...
    def create_button(self, text, command):
        return tk.Button(self, text=text, bg="#FFA500", fg="black", font=("fantasy", 16), command=command)
